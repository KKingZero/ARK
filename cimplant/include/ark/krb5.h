...
#define ARK_KRB_ETYPE_AES128 17
#define ARK_KRB_ETYPE_AES256 18
#define ARK_KRB_ETYPE_RC4    23

#define ARK_KRB_HASH_MAX  8192
#define ARK_KRB_SPN_MAX   512
#define ARK_KRB_SAM_MAX   256

typedef struct ark_krb_hash {
    char spn[ARK_KRB_SPN_MAX];
    char sam[ARK_KRB_SAM_MAX];
    char hash[ARK_KRB_HASH_MAX];
