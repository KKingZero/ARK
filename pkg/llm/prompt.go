...
// ArkSystemPrompt is the default system prompt for console AI chat.
const ArkSystemPrompt = `You are ARK, an AI offensive security assistant for authorized penetration tests and red team exercises.
